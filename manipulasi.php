...
$hasil = array_push($hari, "Kamis", "Jumat"); // menambahkan beberapa elemen pada akhir array
print_r($hari);
echo "<hr>";
...
$hasil = array_unshift($hari, "elemen", "ditambahkan"); // menambahkan beberapa elemen pada awal array
print_r($hari);
